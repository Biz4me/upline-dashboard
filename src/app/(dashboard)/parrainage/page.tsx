  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      <div>
        ...
        <p className="text-[var(--text-secondary)] mt-1">Partagez Upline.ai et gagnez des mois gratuits</p>
      </div>
      ...
      <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-xl p-6 text-[var(--text-on-card)]">
        ...
        <div className="grid grid-cols-4 gap-2">
          ...
          <button className="flex flex-col items-center gap-1 p-3 bg-[var(--bg)] hover:bg-[#60a5fa]/10 border border-[var(--border)] hover:border-[#60a5fa]/30 rounded-xl transition-all">
            <span className="text-xl">✉️</span>
            <span className="text-[var(--text-muted)] text-xs">Email</span>
          </button>
          <button className="flex flex-col items-center gap-1 p-3 bg-[var(--bg)] hover:bg-[#0077b5]/10 border border-[var(--border)] hover:border-[#0077b5]/30 rounded-xl transition-all">
            <span className="text-xl">💼</span>
            <span className="text-[var(--text-muted)] text-xs">LinkedIn</span>
          </button>
          <button className="flex flex-col items-center gap-1 p-3 bg-[var(--bg)] hover:bg-[#E2B84A]/10 border border-[var(--border)] hover:border-[#E2B84A]/30 rounded-xl transition-all">
            <span className="text-xl">📱</span>
            <span className="text-[var(--text-muted)] text-xs">SMS</span>
          </button>
        </div>
      </div>
      ...
      <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-xl p-6 text-[var(--text-on-card)]">
        ...
        <div className="p-4 bg-[#E2B84A]/5 border border-[#E2B84A]/20 rounded-xl mb-4">
          ...
          <div className="flex items-center gap-3">
            <div className="flex-1 bg-[var(--gold-muted)] rounded-full h-2">
          ...
          <p className="text-[var(--text-muted)] text-xs mt-2">Prochain palier : 5 filleuls → 2 mois bonus</p>
        </div>

        {/* Phase 2 teaser */}
        <div className="p-4 bg-[var(--gold-muted)]/50 border border-[var(--border)] rounded-xl opacity-60">
          <div className="flex items-center justify-between mb-1">
            <div className="text-[var(--text-muted)] font-semibold text-sm">Phase 2 — Commission cash</div>
            <span className="text-xs bg-[var(--gold-muted)] text-[var(--text-muted)] px-2 py-1 rounded-full">Bientôt</span>
          </div>
      ...
      <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-xl p-6 text-[var(--text-on-card)]">
        ...
        {/* Aperçu carte */}
        <div className="bg-gradient-to-br from-[var(--bg-card)] to-[var(--bg)] border border-[#E2B84A]/20 rounded-xl p-5">
          ...
          <p className="text-[var(--text-muted)] text-xs mt-2">Propulsé par Atlas IA · Upline.ai</p>
        </div>
        <div className="flex gap-2 mt-3">
          ...
          <button className="text-sm bg-[var(--gold-muted)] hover:bg-[var(--gold-muted)] text-[var(--text-secondary)] px-4 py-2 rounded-lg transition-colors">
            QR Code
          </button>
        </div>
      </div>
