export default function Profil() {
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-xl p-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <div className="text-[var(--text-secondary)] text-xs truncate">patricehaure@gmail.com</div>
          </div>
          <div>
            <div className="text-[var(--text-muted)] text-xs mb-1">Membre depuis</div>
            <div className="text-[var(--text-secondary)] text-xs">Mai 2026</div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-xl p-6">
        ...
        <div className="flex items-center justify-between p-4 bg-[#E2B84A]/5 border border-[#E2B84A]/20 rounded-xl mb-4">
          ...
          <div className="text-right">
            <div className="text-[var(--text)] font-bold">$19<span className="text-[var(--text-muted)] text-sm">/mois</span></div>
      ...
      <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-xl p-6">
        ...
        <div className="space-y-3">
          <button className="w-full flex items-center justify-between gap-2 p-3 bg-[var(--bg)] hover:bg-[var(--gold-muted)] rounded-lg transition-colors">
            <span className="text-[var(--text-secondary)] text-sm truncate">📄 Rapport mensuel Mai 2026</span>
            <span className="text-[#E2B84A] text-xs flex-shrink-0">PDF</span>
          </button>
          <button className="w-full flex items-center justify-between gap-2 p-3 bg-[var(--bg)] hover:bg-[var(--gold-muted)] rounded-lg transition-colors">
            <span className="text-[var(--text-secondary)] text-sm truncate">💳 Carte de visite digitale</span>
            <span className="text-[#E2B84A] text-xs flex-shrink-0">Voir</span>
          </button>
          <button className="w-full flex items-center justify-between gap-2 p-3 bg-[var(--bg)] hover:bg-[var(--gold-muted)] rounded-lg transition-colors">
            <span className="text-[var(--text-secondary)] text-sm truncate">📊 Historique coaching</span>
      ...
      <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-xl p-6">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between p-3 bg-[var(--bg)] rounded-lg">
            <span className="text-[var(--text-secondary)] text-sm">🌙 Mode sombre</span>
          ...
          <div className="flex items-center justify-between p-3 bg-[var(--bg)] rounded-lg">
            <span className="text-[var(--text-secondary)] text-sm">🔔 Notifications push</span>
            <div className="w-10 h-5 bg-[#E2B84A] rounded-full relative cursor-pointer">
              <div className="w-4 h-4 bg-black rounded-full absolute right-0.5 top-0.5"></div>
            </div>
          </div>
          <div className="flex items-center justify-between p-3 bg-[var(--bg)] rounded-lg">
            <span className="text-[var(--text-secondary)] text-sm">🌍 Langue</span>
      ...
      {/* Danger zone */}
      <div className="bg-[var(--bg-card)] border border-red-900/30 rounded-xl p-6">
