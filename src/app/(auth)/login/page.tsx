      ...
      <div style={{ width: '100%', maxWidth: 440, position: 'relative' }}>
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          <Link href="/landing" style={{ display: 'inline-flex', alignItems: 'center', gap: 10, textDecoration: 'none' }}>
            ...
            <span style={{ fontSize: 24, fontWeight: 800, background: 'linear-gradient(135deg, #6D5EF5, #22D3EE)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
              Atline.ai
            </span>
          </Link>
        </div>
        ...
        <div style={{ background: '#111827', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 24, padding: '40px 36px', boxShadow: '0 24px 64px rgba(0,0,0,0.4)' }}>
          <h1 style={{ fontSize: 26, fontWeight: 800, color: 'white', marginBottom: 8, textAlign: 'center' }}>
            Bon retour 👋
          </h1>
          <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.45)', textAlign: 'center', marginBottom: 32 }}>
            Connectez-vous à votre espace Atline.ai
          </p>

          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div>
              <label style={{ fontSize: 12, fontWeight: 700, color: 'rgba(255,255,255,0.5)', textTransform: 'uppercase', letterSpacing: 1, display: 'block', marginBottom: 8 }}>
                Email ou pseudo
              </label>
              <input
                type="text"
        ...
        <p style={{ textAlign: 'center', fontSize: 12, color: 'rgba(255,255,255,0.25)', marginTop: 24 }}>
          ✓ Aucune carte requise &nbsp;•&nbsp; ✓ 7 jours gratuits &nbsp;•&nbsp; ✓ Annulation immédiate
        </p>
      </div>
    </div>
  )
